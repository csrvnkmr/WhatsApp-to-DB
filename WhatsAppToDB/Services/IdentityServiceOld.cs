...
{
    public class IdentityServiceOld : IIdentityService
    {
        ...
        public IdentityServiceOld(IOptions<RoleSettings> roleSettings,
        ...
        public void HydrateRolePermissions(IdentityContext identity)
        {
            ...
            identity.ConnectionString = !string.IsNullOrEmpty(roleConn) ? roleConn : _databaseContextService.GetCurrentConfig().ConnectionString;
        }
