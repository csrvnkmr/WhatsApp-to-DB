...
{
    public async static Task TestSearchCollection(ISyncService syncService, string collectionName, string searchText)
    {
    ...
    public async static Task TestSearchAW(ISyncService vss)
    {
    ...
    public async static Task TestSearchB1(ISyncService vss)
    {
    ...
    public async static Task TestSearchB1_2(ISyncService vss)
    {
    ...
    public async static Task TestChromaSearch(VectorSyncService dvss)
    {
